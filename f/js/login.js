const login = async () => {
    ...
    try {
        ...
        if (response.ok) {
            ...
            switch (data.role) {
                case 'admin':
                    window.location.href = 'f/html/admin/admin.html';
                    break;
                case 'rector':
                    window.location.href = 'f/html/rector.html';
                    break;
                case 'estudiante':
                    window.location.href = 'f/html/estudiante/estudiantes.html';
                    break;
                case 'profesor':
                    window.location.href = 'f/html/profesor/profesores.html';
                    break;
                default:
